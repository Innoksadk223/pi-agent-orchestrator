...
export default function agentOrchestrator(pi: ExtensionAPI) {
	...
	pi.registerTool({
		...
		promptGuidelines: [
			"Payloads are validated strictly (every object rejects unknown properties). Aim for schema-exact JSON on the first call. Minimal valid plan: {\"action\":\"plan\",\"team\":\"t1\",\"plan\":{\"members\":[{\"id\":\"coder-a\",\"kind\":\"coder\",\"role\":\"Implement X\",\"instructions\":\"...\"},{\"id\":\"rev\",\"kind\":\"reviewer\",\"role\":\"Verify X\",\"instructions\":\"...\"}],\"reviewerId\":\"rev\",\"tasks\":[{\"id\":\"task-1\",\"memberId\":\"coder-a\",\"objective\":\"...\",\"ownedPaths\":[\"src/a.ts\"],\"acceptance\":[\"checks pass\"]}],\"acceptance\":[\"done criteria\"]}}. Common first-call mistakes: extra fields at any level; task entries missing id/memberId/objective/ownedPaths/acceptance; expectedRevision on an initial plan (forbidden) or missing on an amendment (required); passing member config or objective to run/parallel/review (ids only).",
